...
// ── Simple SQL splitter (splits on ; outside of single‑quoted strings) ──
...
async function handleRequest(req, res) {
  ...
  // ── Write / multi‑statement execution (ALWAYS uses splitting) ──
  ...
  if (execMatch && method === 'POST') {
    ...
    try {
      // Split the whole script into individual statements
